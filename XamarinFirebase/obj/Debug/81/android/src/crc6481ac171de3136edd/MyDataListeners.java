...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XamarinFirebase.EventListeners.MyDataListeners, XamarinFirebase", MyDataListeners.class, __md_methods);
	}


	public MyDataListeners ()
	{
		super ();
		if (getClass () == MyDataListeners.class)
			mono.android.TypeManager.Activate ("XamarinFirebase.EventListeners.MyDataListeners, XamarinFirebase", "", this, new java.lang.Object[] {  });
	}
